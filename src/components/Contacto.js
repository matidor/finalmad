...
const Contacto = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTelefono('');
    setMensaje('');
    setEnviado(true); // Se muestra el mensaje de éxito
        ...
        <div className="formulario-container">
          <div className="formulario">
            <div className="message-container">
              ...
              {enviado ? ( // Mostrar el mensaje de éxito si el formulario se ha enviado
                <p className="mensaje-enviado">Mensaje enviado con éxito!!!<br /> En breve nos comunicaremos contigo.</p>
              ) : (
